...
class Settings(db.Model):
    """Single-row table holding shop-wide settings the admin can edit."""
...
class Product(db.Model):
    ...
    price = db.Column(db.Float, nullable=False)  # base price in GHS
    stock = db.Column(db.Integer, default=0)  # admin-only visibility
    ...
    is_active = db.Column(db.Boolean, default=True)  # admin can manually hide too
    ...
    @property
    def is_visible(self):
        """Whether the item should show on the public storefront."""
...
class Order(db.Model):
    ...
    payment_method = db.Column(db.String(30), default="mobile_money")  # mobile_money | bank
...
class OrderItem(db.Model):
    ...
    product_name = db.Column(db.String(150))  # snapshot, survives product edits/deletion
